function myResources(){
	...
	var json_obj = JSON.parse(Get("http://aztests.azurewebsites.net/ngo/myresources"));
...
function updateResources(){
    ...
    request.open("POST",'http://aztests.azurewebsites.net/ngo/myresources/update',true);
...
function deleteResources(){
    ...
    request.open("POST",'http://aztests.azurewebsites.net/ngo/myresources/delete',true);
    request.setRequestHeader('Content-Type','application/json');
request.send(JSON.stringify({name:name,qty:qty,type:type}));
...
window.onload = function(){
	var json_obj = JSON.parse(Get("http://aztests.azurewebsites.net/ngo/resources"));
